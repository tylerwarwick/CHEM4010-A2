...
\begin{column}{\colwidth}
  ...
  \begin{block}{Metabolism}
    ...
    \begin{center}
      ...
      \captionof{figure}{Major ketamine metabolites and corresponding liver enzymes that have been reported to exhibit pharmological activity in vivo. Schematic adapted from\cite{jelenlukea_2020_ketamine}}
    \end{center}
