...
\begin{column}{\colwidth}
  ...
  \begin{block}{Metabolism}
    ...
    \begin{center}
      ...
      \captionof{figure}{Major ketamine metabolites and corresponding liver enzymes that have been reported to exhibit pharmological activity in vivo.\cite{jelenlukea_2020_ketamine}\cite{dinisoliveira_2017_metabolism} Schematic adapted from\cite{jelenlukea_2020_ketamine}}
    \end{center}
...
\begin{column}{\colwidth}
  ...
  \begin{block}{Mechanism of Action}
    ...
    \begin{center}
      ...
      %\includegraphics[width=0.7\linewidth]{media/ket-enantiomers.jpg}
      \captionof{figure}{Mechanism of action for enantiomeric ketamine and its downstream metabollites. Schematic adapted from\cite{jelenlukea_2020_ketamine}}
    \end{center}
