...
\begin{column}{\colwidth}
  \begin{block}{Synthesis}
    ...
    \begin{center}
      ...
      \captionof{figure}{Historical and modern synthetic strategies for racemic ketamine. (Yen et al., 2023)}
    \end{center}
    ...
    \begin{center}
      ...
      \captionof{figure}{Recycling / stereospecific synthesis (Gao et al., 2020)}
    \end{center}
