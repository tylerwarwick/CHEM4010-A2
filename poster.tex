...
\begin{column}{\colwidth}
  ...
  \begin{block}{A block title}
    \begin{minipage}[t]{0.6\textwidth}  % left side: text
      Some block contents, followed by a paragraph of text.
      ...
      More text can go here and will naturally flow below the figure as well.
    \end{minipage}
    \hfill
    \begin{minipage}[t]{0.35\textwidth}  % right side: figure
      %\centering
      \vspace{0pt}  % optional: pull the figure up a bit to align with text
      \includegraphics[width=\linewidth]{media/ket-structure.jpg}  % specify height, not width
      \captionof{figure}{Ketamine structure. [YART]}       % caption without float
    \end{minipage}
